		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#regestaregestarapportini-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"regestaregestarapportini-display": {
								"semanticObject": "regestaregestarapportini",
								"action": "display",
								"description": "Gestione ticket e rapportini",
								"title": "Gestione Rapportini",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=regesta.regestarapportini",
									"url": sap.ui.require.toUrl("regesta/regestarapportini")
								}
							}
						}
					}
