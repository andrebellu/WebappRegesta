...
=======
  ...
  function (
    ...
    return Controller.extend("regesta.regestarapportini.controller.Tickets", {
      onInit: function () {
        var oModel = new JSONModel();
>>>>>>> 3eec1487a0a9ed6bdd5416f9821b7ef1274e3e8f
...
>>>>>>> 3eec1487a0a9ed6bdd5416f9821b7ef1274e3e8f
      ...
      APIcommesse: function () {
        ...
        fetch(
          sessionStorage.getItem("hostname") +
            "/api_v2/commesse?token=mF2rK0g%252bNh1xJnGB72RasA%253d%253d&idCommessa=0&idCliente=0",
          request
        )
          .then((response) => response.text())
          .then((result) => this.handleCommesse(result))
      ...
      APIticket: function () {
        ...
        fetch(
          sessionStorage.getItem("hostname") +
            "/api_v2/ticket?token=mF2rK0g%252bNh1xJnGB72RasA%253d%253d&idTicket=0",
          request
        )
          .then((response) => response.text())
          .then((result) => this.handleTicket(result))
